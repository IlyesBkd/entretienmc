...
const situationsEN = [
    ...
    {
        question: "🏃‍♂️ Nouvelle exigence réglementaire en cours de projet",
        answer: "I welcome the new requirement by conducting a <strong>compliance impact assessment</strong> to understand how it affects our current project. I gather the <strong>legal and compliance teams</strong> to evaluate the <strong>implementation effort</strong> and <strong>timeline impact</strong>.\n\nI then present the client with <strong>updated compliance options</strong> and revised project timeline. I ensure all new requirements are properly <strong>documented and validated</strong> before proceeding.\n\nOnce approved, I immediately update the <strong>project scope</strong> and engage the team to implement the <strong>compliance measures</strong>."
    },
    {
        question: "🐛 Problèmes de qualité des données en production",
        answer: "I organize an <strong>immediate investigation</strong> to identify the root cause of data quality issues. I analyze the <strong>data pipeline</strong> and <strong>validation processes</strong> to pinpoint where the problem occurred.\n\nI then implement <strong>immediate fixes</strong> to restore data quality and set up <strong>additional monitoring</strong> to prevent recurrence. I document all changes and update the <strong>data governance procedures</strong>.\n\nFinally, I conduct a <strong>post-incident review</strong> to improve our data quality controls and prevent similar issues in the future."
    },
    {
        question: "🔄 Conformité des transferts transfrontaliers de données",
        answer: "I start by reviewing the <strong>current data transfer mechanisms</strong> and <strong>regulatory requirements</strong> for both source and destination countries. I assess whether we have adequate <strong>legal safeguards</strong> and <strong>data protection measures</strong> in place.\n\nIf compliance gaps are identified, I work with <strong>legal teams</strong> to implement necessary <strong>standard contractual clauses</strong> or <strong>binding corporate rules</strong>. I ensure all transfers are properly <strong>documented and monitored</strong>.\n\nIn parallel, I update our <strong>data transfer procedures</strong> and provide training to teams on <strong>cross-border compliance requirements</strong>."
    },
    {
        question: "🌌 Échéance réglementaire approche - Pression temporelle",
        answer: "I have a <strong>regulatory monitoring system</strong> that tracks upcoming deadlines. When a deadline approaches, I immediately assess our <strong>compliance status</strong> and identify any <strong>gaps or risks</strong>.\n\nI then prioritize actions based on <strong>regulatory impact</strong> and <strong>implementation complexity</strong>. I work closely with <strong>compliance and legal teams</strong> to ensure all requirements are met on time.\n\nI maintain <strong>regular communication</strong> with stakeholders about our progress and any potential challenges, ensuring we meet all <strong>regulatory deadlines</strong>."
    },
    {
        question: "💰 Contraintes budgétaires compliance - Priorisation des risques",
        answer: "I organize a meeting with <strong>compliance stakeholders</strong> and <strong>risk management teams</strong> to assess our current compliance status and identify <strong>high-priority risks</strong>. I prioritize compliance measures based on <strong>regulatory impact</strong> and <strong>risk exposure</strong>.\n\nI then propose a <strong>phased compliance approach</strong> that addresses the most critical requirements first while staying within budget constraints. I ensure all <strong>essential compliance measures</strong> are implemented.\n\nFinally, I document our <strong>compliance strategy</strong> and regularly review our progress to ensure we maintain <strong>regulatory compliance</strong> despite budget limitations."
    }
];
...
function updateLanguage() {
    if (currentLanguage === 'en') {
        ...
        mainTitle.textContent = 'Société Générale Interview Questions';
        ...
        mainTitle.textContent = 'Questions d\'Entretien smartTrade';
